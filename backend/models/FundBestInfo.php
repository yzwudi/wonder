...
/**
 * This is the model class for table "fund_best_info".
 *
 * @property integer $id
 ...
 */
class FundBestInfo extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['fund_id', 'name_en', 'date', 'poundage', 'create_time'], 'string', 'max' => 32],
            [['name'], 'string', 'max' => 64],
        ];
    }
